...
namespace Graphs
{
    ...
    class Graph<T>
    {
        ...
        public bool AddEdge(T tail, T head)
        {
            ...
            else if (tailNode.Neighbors.Contains(headNode))
            {
                // edge already exists
                return false;
            }
        ...
        /// </summary>
        /// <param name="tail">first value to disconnect</param>
        /// <param name="head">second value to disconnect</param>
        /// <returns>true if the edge is removed, false otherwise</returns>
        public bool RemoveEdge(T tail, T head)
        {
            GraphNode<T> tailNode = Find(tail);
            GraphNode<T> headNode = Find(head);
            if (tailNode == null ||
