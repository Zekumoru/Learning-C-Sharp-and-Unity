...
namespace Graphs
{
    ...
    static class TestGraph
    {
        ...
        static void TestAddEdgeValid()
        {
            ...
            graph.AddNode(4);
            graph.AddNode(5);
            bool success = graph.AddEdge(4, 5); // 4 -> 5
        ...
        static void TestRemoveNodeMultipleNeighbors()
        {
            ...
            // 4 -> 5, 6
            // 5 -> 6
            // or [Node Value: 4 Neighbors: 5, 6 ], [Node Value: 5 Neighbors: 6 ], [Node Value: 6 Neighbors:  ]
            bool success = graph.RemoveNode(4);
            // Now it is: [Node Value: 5 Neighbors: 6 ], [Node Value: 6 Neighbors: ]
        ...
        static void TestRemoveEdgeNodeNotFound()
        {
            ...
            graph.AddNode(5);
            graph.AddEdge(4, 5); // 4 -> 5
            // [Node Value: 4 Neighbors: 5 ], [Node Value: 5 Neighbors: ]
        ...
        static void TestRemoveEdgeEdgeNotFound()
        {
            ...
            graph.AddNode(6);
            graph.AddEdge(4, 5); // 4 -> 5
            // [Node Value: 4 Neighbors: 5 ], [Node Value: 5 Neighbors: ], [Node Value: 6 Neighbors: ]
            bool success = graph.RemoveEdge(4, 6);
